...
class NovelGridworldV1Env(gym.Env):
    ...
    def __init__(self, map_width=None, map_height=None, items_id=None, items_quantity=None, initial_inventory = None, goal_env = None, is_final = False):
        ...
        ### add fence
        ####################################################
        self.items = ['wall', 'tree', 'rock', 'rubber_tree', 'crafting_table', 'fence', 'pogo_stick']
        ...
        ### set the quantity of fence as 3 (might be changed) ###
        ###################################################
        self.items_quantity = {'tree': 6, 'rock': 2, 'rubber_tree' : 1, 'crafting_table': 1, 'fence': 3, 'pogo_stick': 0}
        ...
        ### wall是边界，不是obj
        ############################################################
        self.items_lidar = ['wall', 'crafting_table', 'tree', 'rock', 'rubber_tree', 'fence']
    ...
    def add_item_to_map(self, item, num_items):
        ...
        while True:
            ...
            ### maybe fence can be put closely next to other items? ###
            ##############################################################
    ...
    def step(self, action):
        ...
        """
        ### the fence: the agent can take any action, but with a fence nothing is changed ###
        ### it only influences the action 0--forward
        ### no change added
        ...
        if action ==0: # forward
            ...
            self.update_block_in_front()
            # If block in front is not air and wall and fence, place the block in front in inventory
